...
Написана программа для кулинарной книги.
...
* Соблюден кодстайл, новая логика разбита на функции.

## Задача №1

Реализован следующий словарь:
...
Написана функция, которая на вход принимает список блюд из cook_book и количество персон, для кого мы будем готовить:
